# --- Web bucket: static SPA build, private, read only via CloudFront (OAC) ---
...
# --- Content bucket: profile/answers/questions, private, versioned, read
# only by the Lambda's execution role (see lambda.tf) ---
